================================================================================
    MFC 程式庫 : AccountSystemMFC 專案概觀
===============================================================================

應用程式精靈已經為您建立了這個 AccountSystemMFC 應用程式。這個應用程式
不僅示範了使用 MFC 的基本概念，也是您撰寫應用程式的起點。

這個檔案的內容摘要，包含各個構成 AccountSystemMFC 應用程式的檔案。

AccountSystemMFC.vcproj
...
AccountSystemMFC.h
    ...
    並宣告 CAccountSystemMFCApp 應用程式類別。

AccountSystemMFC.cpp
    這是主要的應用程式原始程式檔，它包含應用程式類別 CAccountSystemMFCApp。
...
res\AccountSystemMFC.ico
    這個圖示檔是用來做為應用程式的圖示。這個圖示包含在主要資源檔
    AccountSystemMFC.rc 內。

res\AccountSystemMFC.rc2
...
StdAfx.h、StdAfx.cpp
    這些檔案是用來建置名為 AccountSystemMFC.pch 的先行編譯標頭 (PCH) 檔，
